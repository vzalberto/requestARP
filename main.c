...
//Recepcion
	...
	do{
		...
		if((ntohs(msg.tipoARP) == ARPOP_REPLY) && !strncmp(ip, msg.origenIP, 4))
			{
				fprintf(stdout, RESPUESTA, argv[2], 
					msg.origenMAC[0], msg.origenMAC[1], msg.origenMAC[2],
					msg.origenMAC[3], msg.origenMAC[4], msg.origenMAC[5]);
				break;
			}
		}while(1);
